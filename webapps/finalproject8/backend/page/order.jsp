...
<%
  ...
  database.query("select * from mycart");
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">訂單管理</h4> </div>
                             ...
                             <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      %>
                                        <tr>
                                          <form id = "form<%=cart%>" action="edit.jsp" method="POST">
                                            <td><%=cart%></td>
                                            <td id = "c_id<%=cart%>"><%=c_id%></td>
                                            <td id = "p_id<%=cart%>"><%=p_id%></td>
                                            <td id = "quantity<%=cart%>"><%=quantity%></td>
                                            <%-- <td>
                                              <button type = "button" id = "edit<%=cart%>" type="button" class="btn btn-primary">修改</button>
                                            </td>
                                            <td>
                                              <button id = "delete<%=cart%>" type="button" class="btn btn-danger">刪除</button>
                                            </td> --%>
                                          </form>
                                        </tr>
                                      <% }}%>
